...
class ConfiguracaoContratoType extends AbstractType
{
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        ...
        $builder->add('fkLicitacaoVeiculosPublicidade', EntityType::class, [
            'class' => VeiculosPublicidade::class,
            'label' => 'Veículo de Publicação',
            'placeholder' => 'Selecione',
            'attr' => ['class' => 'select2-parameters '],
            'choice_label' => function (VeiculosPublicidade $veiculosPublicidade) {
    ...
    private function getCodModalidadeLicitacao($fkTcemgContratoModalidadeLicitacao)
    {
        if (true === $fkTcemgContratoModalidadeLicitacao instanceof Contrato) {
            $codModalidadeLicitacao = $fkTcemgContratoModalidadeLicitacao->getFkTcemgContratoModalidadeLicitacao();
            ...
            $codModalidadeLicitacao = $fkTcemgContratoModalidadeLicitacao['fkTcemgContratoModalidadeLicitacao'];
        }

        return (int) $codModalidadeLicitacao;
    }

    private function getCodObjeto($fkTcemgContratoObjeto)
    {
        if (true === $fkTcemgContratoObjeto instanceof Contrato) {
            $codObjeto = $fkTcemgContratoObjeto->getFkTcemgContratoObjeto();
            ...
            $codObjeto = $fkTcemgContratoObjeto['fkTcemgContratoObjeto'];
        }
